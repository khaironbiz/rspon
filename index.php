...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
    ...
    <a href="auth" class="w3-padding-large w3-hover-red w3-hide-small w3-right"><i class="fa fa-sign-in"></i></a>
  </div>
</div>
...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-display-container w3-wide" id="home">
    <img class="w3-image" src="assets/images/landing/hospital.jpg" alt="Fashion Blog" width="1600" height="1060">
  </header>
  ...
  <div class="w3-row w3-padding w3-border">
    ...
    <div class="w3-white w3-margin">
        <img src="assets/images/landing/mursyid.jpg" alt="Jane" style="width:100%" class="w3-grayscale">
    ...
    <hr>
      ...
      <div class="w3-white w3-margin">
        ...
        <div class="w3-row-padding w3-white">
          <div class="w3-col s6">
            <p><img src="assets/images/landing/room.jpg" alt="Jeans" style="width:100%"></p>
            <p><img src="assets/images/landing/bs.jpg" alt="Jeans" style="width:100%"></p>
          </div>
          <div class="w3-col s6">
            <p><img src="assets/images/landing/farmacy.jpg" alt="Men in Hats" style="width:100%" class="w3-grayscale"></p>
            <p><img src="assets/images/landing/ttv.jpg" alt="Jeans" style="width:100%"></p>
         </div>
        </div>
      </div>
      <hr>
